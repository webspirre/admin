...
const UploadInitial: React.FC<UploadInitiaProp> = ({ fileSize }) => {
  return (
    <>
      <div className="bg-[#FDFAF7] px-auto w-full py-20 justify-center items-center flex flex-col space-y-4 h-[120px] overflow-hidden rounded-xl border border-slate-100 z-10">
        <img
          height={50}
          width={50}
